...
// exports.addBuddies = (AuctionID, userId) => Auction.updateOne({ _id: AuctionID }, { $push: { "Buddies" : userId } }, { runValidators: true })
...
exports.updateRooms = (AuctionID, AuctionData) => Auction.updateOne({ _id: AuctionID }, { $set: AuctionData }, { runValidators: true })
